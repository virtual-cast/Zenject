...
namespace Zenject.ReflectionBaking.Mono.Cecil.Tests {
	...
	public class TypeDefinitionRocksTests {
		...
		public void GetConstructors ()
		{
			...
			var expected = new [] {
				"System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::.cctor()",
				"System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::.ctor(System.Int32)",
				"System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::.ctor(System.Int32,System.String)",
			};
		...
		public void GetStaticConstructor ()
		{
			...
			Assert.AreEqual ("System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::.cctor()", cctor.FullName);
		}
		...
		public void GetMethods ()
		{
			...
			Assert.AreEqual ("System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::Bar()", methods [0].FullName);
			Assert.AreEqual ("System.Void Zenject.ReflectionBaking.Mono.Cecil.Tests.TypeDefinitionRocksTests/Foo::Baz()", methods [1].FullName);
		}
